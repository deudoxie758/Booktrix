...
describe('WorkspaceOverview', () => {
  ...
  it('renders owner alerts and operational quick links', () => {
    ...
    expect(screen.getByText(/19 Aug 2026, 11:00 am – 19 Aug 2026, 12:00 pm/)).toBeVisible()
  ...
  it('shows staff the locations where their assigned work is scoped', () => {
    ...
    expect(screen.getByText(/19 Aug 2026, 11:00 am – 19 Aug 2026, 12:00 pm/)).toBeVisible()
    expect(screen.getByText(/19 Aug 2026, 1:00 pm – 19 Aug 2026, 2:00 pm/)).toBeVisible()
  })
})
